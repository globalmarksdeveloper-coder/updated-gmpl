  ...
  return (
    <div style={{ background:"#fff", border:"1px solid #E2E8F0", borderRadius:16, overflow:"hidden", marginBottom:20 }}>
      ...
      <div style={{ background:"linear-gradient(135deg,#1E3A8A,#1e40af)", padding:"14px 20px", display:"flex", alignItems:"center", justifyContent:"space-between", flexWrap:"wrap", gap:8 }}>
        <div>
          <div style={{ fontFamily:"Poppins,sans-serif", fontWeight:800, fontSize:14, color:"#fff" }}>🎯 Monthly Target Progress</div>
    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .topbar { background: #1E3A8A; display: flex; align-items: center; justify-content: space-between; padding: 0 20px; height: 54px; gap: 8px; }
        .logo { display: flex; align-items: center; gap: 8px; min-width: 0; flex: 1; }
        .logo-icon { width: 30px; height: 30px; border-radius: 7px; background: rgba(255,255,255,0.15); display: flex; align-items: center; justify-content: center; font-family: 'Poppins', sans-serif; font-weight: 800; font-size: 11px; color: #fff; flex-shrink: 0; }
        ...
        .top-clock { font-family: 'Poppins', sans-serif; font-size: 15px; font-weight: 800; color: #10B981; flex-shrink: 0; }
        .top-right { display: flex; align-items: center; gap: 6px; flex-shrink: 0; }
        .ba-pill { padding: 3px 8px; border-radius: 20px; background: rgba(16,185,129,0.2); font-size: 10px; color: #6EE7B7; font-weight: 600; white-space: nowrap; }
        ...
        .rules-btn { padding: 4px 10px; border-radius: 6px; border: 1px solid rgba(255,255,255,0.2); background: rgba(255,255,255,0.08); color: rgba(255,255,255,0.8); font-size: 11px; font-weight: 600; cursor: pointer; display: flex; align-items: center; gap: 4px; flex-shrink: 0; }
        .rules-btn:hover { background: rgba(255,255,255,0.15); }
        .logout-btn { padding: 4px 10px; border-radius: 6px; border: 1px solid rgba(255,255,255,0.2); background: transparent; color: rgba(255,255,255,0.7); font-size: 11px; cursor: pointer; flex-shrink: 0; }
        .logout-btn:hover { background: rgba(255,255,255,0.1); color: #fff; }
        @media(max-width:600px) { .logo-sub { display: none; } .ba-pill { display: none; } .store-pill { display: none; } .top-clock { font-size: 13px; } .logo-name { font-size: 12px; } .rules-btn span { display: none; } }
        @media(max-width:400px) { .logout-btn { display: none; } }
        .main { padding: 24px 28px; max-width: 1100px; margin: 0 auto; }
        .top-stats { display: grid; grid-template-columns: repeat(4, 1fr); gap: 12px; margin-bottom: 20px; }
        .scard { background: #fff; border: 1px solid #E2E8F0; border-radius: 14px; padding: 16px 18px; }
        .scard-label { font-size: 10px; color: #94A3B8; text-transform: uppercase; letter-spacing: 0.1em; margin-bottom: 6px; }
        .scard-value { font-family: 'Poppins', sans-serif; font-size: 20px; font-weight: 800; color: #0F172A; }
        .scard-sub { font-size: 11px; color: #94A3B8; margin-top: 3px; }
        .mid-grid { display: grid; grid-template-columns: 380px 1fr; gap: 20px; margin-bottom: 20px; }
        .geo-card { background: #fff; border: 1px solid #E2E8F0; border-radius: 20px; padding: 20px; display: flex; flex-direction: column; gap: 14px; }
        .checkin-card { background: #fff; border: 1px solid #E2E8F0; border-radius: 20px; padding: 32px 24px; display: flex; flex-direction: column; align-items: center; gap: 20px; }
        .checkin-title { font-family: 'Poppins', sans-serif; font-size: 15px; font-weight: 700; color: #64748B; text-align: center; }
        ...
        .circle-btn { width: 155px; height: 155px; border-radius: 50%; border: none; cursor: pointer; display: flex; flex-direction: column; align-items: center; justify-content: center; gap: 5px; transition: all 0.3s; position: relative; z-index: 1; font-family: 'Poppins', sans-serif; }
        .circle-btn:hover:not(:disabled) { transform: scale(1.06); }
        .circle-btn:disabled { cursor: not-allowed; opacity: 0.6; }
        .btn-label { font-size: 14px; font-weight: 800; letter-spacing: 0.08em; }
        .btn-sub { font-size: 10px; letter-spacing: 0.04em; opacity: 0.7; }
        .timer-big { font-family: 'Poppins', sans-serif; font-size: 30px; font-weight: 800; letter-spacing: 0.04em; }
        .break-btn { padding: 9px 24px; border-radius: 10px; font-family: 'Poppins', sans-serif; font-size: 12px; font-weight: 700; cursor: pointer; transition: all 0.2s; letter-spacing: 0.04em; }
        .break-idle { border: 2px solid #F59E0B; background: #FFFBEB; color: #D97706; }
        .break-idle:hover { background: #FEF3C7; }
        .break-active { border: 2px solid #F59E0B; background: #F59E0B; color: #fff; }
        .timeline { width: 100%; display: flex; flex-direction: column; gap: 8px; }
        .titem { display: flex; align-items: center; gap: 10px; padding: 9px 14px; background: #F8FAFC; border-radius: 9px; border: 1px solid #E2E8F0; }
        .tdot { width: 8px; height: 8px; border-radius: 50%; flex-shrink: 0; }
        .tlabel { font-size: 12px; color: #64748B; flex: 1; }
        .ttime { font-size: 12px; font-family: 'Poppins', sans-serif; font-weight: 700; }
        .done-card { background: linear-gradient(135deg, #EEF2FF, #F0FDF4); border: 2px solid #C7D2FE; border-radius: 16px; padding: 20px; text-align: center; width: 100%; }
        .done-title { font-family: 'Poppins', sans-serif; font-size: 16px; font-weight: 800; color: #4338CA; margin-bottom: 6px; }
        .done-sub { font-size: 12px; color: #6366F1; }
        .location-card { background: #fff; border: 1px solid #E2E8F0; border-radius: 20px; padding: 20px; display: flex; flex-direction: column; gap: 14px; }
        .loc-title { font-family: 'Poppins', sans-serif; font-size: 14px; font-weight: 700; color: #0F172A; display: flex; align-items: center; justify-content: space-between; }
        .loc-accuracy { font-size: 10px; font-weight: 500; padding: 2px 8px; border-radius: 20px; background: #F0FDF4; color: #15803D; border: 1px solid #BBF7D0; }
        .loc-box { display: flex; align-items: center; justify-content: space-between; padding: 12px 14px; background: #F8FAFC; border-radius: 10px; border: 1px solid #E2E8F0; gap: 10px; }
        .loc-row { display: flex; align-items: center; gap: 10px; flex: 1; min-width: 0; }
        .loc-pulse { width: 8px; height: 8px; border-radius: 50%; background: #10B981; flex-shrink: 0; animation: pls 2s ease-in-out infinite; }
        .loc-text { font-size: 12px; font-weight: 600; color: #0F172A; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; }
        .loc-coords { font-size: 10px; color: #94A3B8; margin-top: 2px; }
        .loc-refresh { padding: 5px 12px; border-radius: 7px; border: 1px solid #E2E8F0; background: #fff; color: #64748B; font-size: 11px; cursor: pointer; font-weight: 600; flex-shrink: 0; }
        .loc-refresh:hover { background: #F1F5F9; }
        .summary-grid { display: grid; grid-template-columns: 1fr 1fr; gap: 8px; width: 100%; }
        .sum-item { background: #F8FAFC; border-radius: 10px; border: 1px solid #E2E8F0; padding: 10px 14px; }
        .sum-label { font-size: 10px; color: #94A3B8; text-transform: uppercase; letter-spacing: 0.08em; margin-bottom: 4px; }
        .sum-val { font-family: 'Poppins', sans-serif; font-size: 14px; font-weight: 800; }
        .bot-grid { display: grid; grid-template-columns: 1fr 340px; gap: 20px; }
        .sales-card { background: #fff; border: 1px solid #E2E8F0; border-radius: 20px; padding: 20px; display: flex; flex-direction: column; gap: 12px; }
        .brands-card { background: #fff; border: 1px solid #E2E8F0; border-radius: 20px; padding: 20px; display: flex; flex-direction: column; gap: 14px; }
        .card-head { display: flex; align-items: center; justify-content: space-between; }
        .card-title { font-family: 'Poppins', sans-serif; font-size: 14px; font-weight: 700; color: #0F172A; }
        .add-btn { padding: 7px 14px; border-radius: 8px; border: none; background: #1E3A8A; color: #fff; font-size: 12px; font-weight: 700; cursor: pointer; font-family: 'Poppins', sans-serif; }
        .add-btn:hover { background: #1e40af; }
        .sale-form { background: #F8FAFC; border: 1px solid #E2E8F0; border-radius: 12px; padding: 14px; }
        .qty-wrap { display: flex; align-items: center; border: 1.5px solid #E2E8F0; border-radius: 8px; overflow: hidden; }
        .qty-btn { width: 30px; height: 32px; border: none; background: #F1F5F9; color: #64748B; font-size: 16px; cursor: pointer; display: flex; align-items: center; justify-content: center; font-weight: 700; }
        .qty-btn:hover { background: #E2E8F0; }
        .qty-input { width: 44px; height: 32px; border: none; text-align: center; font-size: 13px; font-weight: 700; color: #0F172A; outline: none; }
        .form-total { display: flex; justify-content: space-between; align-items: center; padding: 10px 14px; background: #EFF6FF; border-radius: 10px; border: 1px solid #BFDBFE; }
        .form-total-label { font-size: 12px; font-weight: 700; color: #1D4ED8; }
        .form-total-val { font-family: 'Poppins', sans-serif; font-size: 18px; font-weight: 800; color: #1D4ED8; }
        .remarks-input { width: 100%; border: 1.5px solid #E2E8F0; border-radius: 8px; padding: 8px 12px; font-size: 12px; font-family: inherit; resize: vertical; outline: none; color: #0F172A; margin-top: 8px; }
        .fsave { width: 100%; padding: 11px; border-radius: 10px; border: none; background: #10B981; color: #fff; font-family: 'Poppins', sans-serif; font-size: 13px; font-weight: 700; cursor: pointer; margin-top: 8px; letter-spacing: 0.04em; }
        .fsave:hover { background: #059669; }
        ...
        .confirm-box { background: #fff; border-radius: 20px; padding: 32px 28px; max-width: 340px; width: 100%; display: flex; flex-direction: column; align-items: center; gap: 12px; }
        .confirm-icon { font-size: 40px; }
        .confirm-title { font-family: 'Poppins', sans-serif; font-size: 18px; font-weight: 800; color: #0F172A; }
        ...
        .confirm-yes { flex: 1; padding: 10px; border-radius: 10px; border: none; background: #EF4444; color: #fff; font-size: 13px; font-weight: 700; cursor: pointer; box-shadow: 0 4px 12px rgba(239,68,68,0.3); }
        .confirm-yes:hover { background: #DC2626; }
        .confirm-yes:disabled { opacity: 0.6; cursor: not-allowed; }
        .rules-box { background: #fff; border-radius: 20px; padding: 24px; max-width: 360px; width: 100%; display: flex; flex-direction: column; gap: 12px; }
        .rules-header { display: flex; align-items: center; justify-content: space-between; }
        .rules-title { font-family: 'Poppins', sans-serif; font-size: 16px; font-weight: 800; color: #0F172A; }
        ...
        .toast { position: fixed; bottom: 24px; left: 50%; transform: translateX(-50%); padding: 10px 20px; border-radius: 10px; font-size: 13px; font-weight: 600; z-index: 9999; animation: slideup 0.3s ease; white-space: nowrap; }
        ...
        @media(max-width:768px) {
          ...
          .checkin-card { padding: 20px 16px; gap:14px; }
        ...
        @media(max-width:480px) {
          ...
          .scard-value { font-size:16px; }
          .scard-label { font-size:9px; }
          .checkin-card { padding:16px 12px; gap:12px; }
        ...
        /* SALE FORM */
        .sale-form { background: #F8FAFC; border: 1px solid #E2E8F0; border-radius: 12px; padding: 14px; display: flex; flex-direction: column; gap: 0; }
        /* Summary responsive */
          ...
          <div style={{ display:"grid", gridTemplateColumns:"1fr 1fr 1fr", gap:12, marginBottom:20 }}>
            ...
            <div className="scard">
              ...
              <div style={{ display:"flex", alignItems:"center", gap:8, marginTop:8, flexWrap:"wrap" }}>
                <div style={{ textAlign:"center", flex:1 }}>
                  <div style={{ fontFamily:"Poppins,sans-serif", fontSize:26, fontWeight:800, color:"#10B981", lineHeight:1 }}>
                    {attendance?.check_in ? 1 : 0}
                  </div>
                  <div style={{ fontSize:10, color:"#10B981", fontWeight:600, marginTop:3 }}>Present Days</div>
                </div>
                <div style={{ width:1, height:40, background:"#E2E8F0", flexShrink:0 }}/>
                <div style={{ textAlign:"center", flex:1 }}>
                  <div style={{ fontFamily:"Poppins,sans-serif", fontSize:26, fontWeight:800, color:"#EF4444", lineHeight:1 }}>
                    {attendance?.check_in ? 0 : 1}
                  </div>
                  <div style={{ fontSize:10, color:"#EF4444", fontWeight:600, marginTop:3 }}>Absent Days</div>
                </div>
                <div style={{ width:1, height:40, background:"#E2E8F0", flexShrink:0 }}/>
                <div style={{ textAlign:"center", flex:1 }}>
                  <div style={{ fontFamily:"Poppins,sans-serif", fontSize:26, fontWeight:800, color:"#64748B", lineHeight:1 }}>
                    {new Date(new Date().getFullYear(), new Date().getMonth()+1, 0).getDate()}
                  </div>
                  <div style={{ fontSize:10, color:"#64748B", fontWeight:600, marginTop:3 }}>Total Days</div>
                </div>
              </div>
            </div>
            {/* Card 3: Status */}
            <div className="scard">
              ...
              <div style={{ marginTop:8, display:"flex", flexDirection:"column", gap:6 }}>
                <span style={{ padding:"4px 12px", borderRadius:20, fontSize:12, fontWeight:700, display:"inline-flex", alignItems:"center", gap:5, alignSelf:"flex-start",
