    ...
    <>
      <style>{`
        ...
        *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
        ...
        .logo-av{width:30px;height:30px;padding:5px;border-radius:50px;background: #fff;display:flex;align-items:center;justify-content:center;font-weight:800;font-size:11px;color:#fff;flex-shrink:0}
        ...
        <div className="topbar">
          <div className="logo">
            ...
            <div>
              ...
              <div className="logo-name">{data?.tseName || "TSE"} — Dashboard</div>
